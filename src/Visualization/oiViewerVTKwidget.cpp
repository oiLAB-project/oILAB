...
oiViewerVTKwidget::oiViewerVTKwidget(QWidget *)
    : /* init */ mainLayout(new QGridLayout(this))
      /* init */,
      loadBicrystalButton(new QPushButton("Load", this))
      /* init */,
      tabWidget(new QTabWidget(this))
      /* init */,
      openglWidget(new QVTKOpenGLStereoWidget(this))
      /* init */,
      renderWindow(vtkSmartPointer<vtkGenericOpenGLRenderWindow>::New())
      /* init */,
      renderer(vtkSmartPointer<vtkRenderer>::New())
      //    /* init */,traitsIO(getWorkingDir())
      //    /* init */,workingDirLabel(new
      //    QLabel(QString::fromStdString(traitsIO.simulationFolder)))
      /* init */,
      bcActor(new BicrystalActor(renderWindow, renderer))
...
//                    TextFileParser(traitsIO.polyFile).template
//                    readSet<int>("periodicFaceIDs",true))
//    /* init */,meshActor(new SimplicialMeshActor(renderWindow,renderer,mesh))
//    /* init */,ddConfigVtk(new
//    DDconfigVtk(traitsIO.evlFolder,traitsIO.auxFolder,renderWindow,renderer,mesh))
{
  ...
  connect(loadBicrystalButton, SIGNAL(released()), this,
          SLOT(getBicrystalFromFile()));
