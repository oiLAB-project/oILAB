...
namespace oILAB {
template <typename IntScalarType> struct Rational {
  ...
  Rational(const IntScalarType &n_in, const IntScalarType &d_in)
      : /* init */ n(IntegerMath<IntScalarType>::sgn(d_in) * n_in /
                     IntegerMath<IntScalarType>::gcd(abs(n_in), abs(d_in))),
        /* init */ d(IntegerMath<IntScalarType>::sgn(d_in) * d_in /
                     IntegerMath<IntScalarType>::gcd(abs(n_in), abs(d_in))) {}
...
struct NumTraits<oILAB::Rational<IntScalarType>>
    : NumTraits<IntScalarType> // permits to get the epsilon, dummy_precision,
